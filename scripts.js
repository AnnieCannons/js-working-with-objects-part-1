...
servings: 6,
ingredients: ["Fettuccine Noodles", "Alfredo Sauce", "Italian Five Cheeses", "Parsley", "Butter", "Fresh Garlic", "Salt" ],
sides: ["Chicken Breast", "Garlic Bread", "Broccoli", "Garden Salad"],
};

// name = Title (a string, name of recipe)
// Servings (a number)
...
// WITHOUT creating a new variable or accessing the one you just created, log the value of the first language in the "languages" array to the console. You'll have 
// to use BOTH dot notation to access the "languages" array, and square bracket notation to access the first element in that array, all in the same line.
console.log(user3.language[0]);
