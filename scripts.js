...
let favoriteRecipe = {
  title: "'Keto Shrimp Pasta'",
  servings: 4,
  ingredients: ['Medium sized shrimp, tail on', 'egg noodles, olive oil butter', 'minced garlic', 'spinach', 'fresh lemon juice'],
};
...
let titlePage = favoriteRecipe.title;
...
let welcome = ("Welcome back")+ ', ' + user1.name;
// Log the value of that variable to the console.
console.log(welcome);
...
let languagesSpoken = user3.language;
console.log(languagesSpoken[0]);
